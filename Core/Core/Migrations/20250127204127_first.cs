    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d7d7d7d7-d7d7-d7d7-d7d7-d7d7d7d7d7d7"), 0, "a95d8d07-3aee-43a6-b438-8e1fd7da914b", "superadmin@example.com", false, true, false, null, "SUPERADMIN", "SUPERADMIN@EXAMPLE.COM", "SUPERADMIN", "AQAAAAIAAYagAAAAEJA9E5J3aiIT2pLU+ZWgmDDylwqGotZ3hPVHstpQWPuL9b60odChbHlOddRcHU9Rig==", null, false, null, "USER", false, "SUPERADMIN" },
                    { new Guid("e7e7e7e7-e7e7-e7e7-e7e7-e7e7e7e7e7e7"), 0, "96492f22-05a3-4bb2-901c-85c447b0d386", "admin@example.com", false, true, false, null, "ADMIN", "ADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEE54xj0FWyo0yjz7unyGJdqGLCIHoXshIQMBqEsWqms0ZVzVTqKB8Ioo3dCVYnyq+w==", null, false, null, "USER", false, "ADMIN" },
                    { new Guid("f7f7f7f7-f7f7-f7f7-f7f7-f7f7f7f7f7f7"), 0, "90d8811c-c6d2-4fb0-ad69-f26f940a76be", "user@example.com", false, true, false, null, "USER", "USER@EXAMPLE.COM", "USER", "AQAAAAIAAYagAAAAECF1I+11G3JhbB9IGGQJ4bhEJaH2ssBH4av8CX+EkxZ1utCMhu8z7O+F0ezndRokFw==", null, false, null, "USER", false, "USER" }
                });
